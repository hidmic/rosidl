...
#include "rosidl_typesupport_introspection_tests/gtest/introspection_macros.hpp"
...
TYPED_TEST(ArraysMessageIntrospectionTest, MessageDescriptorIsCorrect)
{
  ...
  constexpr auto namespace_separator =
      introspection_traits<ArrayMessageT>::namespace_separator;
  EXPECT_STREQ(get_message_namespace(message_type),
...

  {
    ...
    EXPECT_EQ(get_member_base_type(member_descriptor), ROS_TYPE_BOOLEAN);
...

  {
    ...
    EXPECT_EQ(get_member_base_type(member_descriptor), ROS_TYPE_OCTET);
    EXPECT_TRUE(has_array_structure(member_descriptor, 3u));
  }

  {
    ...
    EXPECT_EQ(get_member_base_type(member_descriptor), ROS_TYPE_CHAR);
    EXPECT_TRUE(has_array_structure(member_descriptor, 3u));
  }

  {
    ...
    EXPECT_EQ(get_member_base_type(member_descriptor), ROS_TYPE_FLOAT32);
    EXPECT_TRUE(has_array_structure(member_descriptor, 3u));
  }

  {
    ...
    EXPECT_EQ(get_member_base_type(member_descriptor), ROS_TYPE_FLOAT64);
    EXPECT_TRUE(has_array_structure(member_descriptor, 3u));
  }

  {
    ...
    EXPECT_EQ(get_member_base_type(member_descriptor), ROS_TYPE_INT8);
    EXPECT_TRUE(has_array_structure(int8_values_member_descriptor, 3u));
  }

  {
    ...
    EXPECT_TRUE(get_member_base_type(member_descriptor), ROS_TYPE_UINT8);
    EXPECT_TRUE(has_array_structure(uint8_values_member_descriptor, 3u));
  }

  {
    ...
    EXPECT_EQ(get_member_base_type(member_descriptor), ROS_TYPE_INT16);
    EXPECT_TRUE(has_array_structure(int16_values_member_descriptor, 3u));
  }

  {
    ...
    EXPECT_EQ(get_member_base_type(member_descriptor), ROS_TYPE_UINT16);
    EXPECT_TRUE(has_array_structure(uint16_values_member_descriptor, 3u));
  }

  {
    ...
    EXPECT_EQ(get_member_base_type(member_descriptor), ROS_TYPE_INT32);
    EXPECT_TRUE(has_array_structure(int32_values_member_descriptor, 3u));
  }

  {
    ...
    EXPECT_EQ(get_member_base_type(member_descriptor), ROS_TYPE_UINT32);
    EXPECT_TRUE(has_array_structure(member_descriptor, 3u));
  }

  {
    ...
    EXPECT_EQ(get_member_base_type(member_descriptor), ROS_TYPE_INT64);
    EXPECT_TRUE(has_array_structure(int64_values_member_descriptor, 3u));
  }

  {
    ...
    EXPECT_EQ(get_member_base_type(member_descriptor), ROS_TYPE_UINT64);
    EXPECT_TRUE(has_array_structure(member_descriptor, 3u));
  }

  {
    ...
    EXPECT_EQ(get_member_base_type(member_descriptor), ROS_TYPE_STRING);
    EXPECT_TRUE(has_array_structure(member_descriptor, 3u));
  }

  {
    auto * member_descriptor = get_member_descriptor(message_descriptor, 14u);
    EXPECT_EQ(get_member_name(member_descriptor), "basic_types_values");
    using basic_type =
...

  {
    ...
    EXPECT_EQ(get_member_name(member_descriptor), "constants_values");
...

  {
    ...
    EXPECT_EQ(get_member_name(member_descriptor), "defaults_values");
    using defaults_type =
...

  {
    ...
    EXPECT_STREQ(get_member_name(member_descriptor), "bool_values_defaults");
    EXPECT_EQ(get_member_base_type(member_descriptor), ROS_TYPE_BOOLEAN);
    EXPECT_TRUE(has_array_structure(member_descriptor, 3u));
  }

  {
    ...
    EXPECT_STREQ(get_member_name(member_descriptor), "byte_values_defaults");
    EXPECT_EQ(get_member_base_type(member_descriptor), ROS_TYPE_OCTET);
    EXPECT_TRUE(has_array_structure(member_descriptor, 3u));
  }
    ...
    EXPECT_STREQ(get_member_name(member_descriptor), "char_values_defaults");
    EXPECT_EQ(get_member_base_type(member_descriptor), ROS_TYPE_CHAR);
    EXPECT_TRUE(has_array_structure(member_descriptor, 3u));
  }

  {
    ...
    EXPECT_STREQ(get_member_name(member_descriptor), "float32_values_defaults");
    EXPECT_EQ(get_member_base_type(member_descriptor), ROS_TYPE_FLOAT32);
    EXPECT_TRUE(has_array_structure(member_descriptor, 3u));
  }

  {
    ...
    EXPECT_STREQ(get_member_name(member_descriptor), "float64_values_defaults");
    EXPECT_EQ(get_member_base_type(member_descriptor), ROS_TYPE_FLOAT64);
    EXPECT_TRUE(has_array_structure(member_descriptor, 3u));
  }

  {
    ...
    EXPECT_STREQ(get_member_name(member_descriptor), "int8_values_defaults");
    EXPECT_EQ(get_member_base_type(member_descriptor), ROS_TYPE_INT8);
    EXPECT_TRUE(has_array_structure(int8_values_member_descriptor, 3u));
  }

  {
    ...
    EXPECT_STREQ(get_member_name(member_descriptor), "uint8_values_defaults");
    EXPECT_TRUE(get_member_base_type(member_descriptor), ROS_TYPE_UINT8);
    EXPECT_TRUE(has_array_structure(uint8_values_member_descriptor, 3u));
  }

  {
    ...
    EXPECT_STREQ(get_member_name(member_descriptor), "int16_values_defaults");
    EXPECT_EQ(get_member_base_type(member_descriptor), ROS_TYPE_INT16);
    EXPECT_TRUE(has_array_structure(int16_values_member_descriptor, 3u));
  }

  {
    ...
    EXPECT_STREQ(get_member_name(member_descriptor), "uint16_values_defaults");
    EXPECT_EQ(get_member_base_type(member_descriptor), ROS_TYPE_UINT16);
    EXPECT_TRUE(has_array_structure(uint16_values_member_descriptor, 3u));
  }

  {
    ...
    EXPECT_STREQ(get_member_name(member_descriptor), "int32_values_defaults");
    EXPECT_EQ(get_member_base_type(member_descriptor), ROS_TYPE_INT32);
    EXPECT_TRUE(has_array_structure(int32_values_member_descriptor, 3u));
  }

  {
    ...
    EXPECT_STREQ(get_member_name(member_descriptor), "uint32_values_defaults");
    EXPECT_EQ(get_member_base_type(member_descriptor), ROS_TYPE_UINT32);
    EXPECT_TRUE(has_array_structure(member_descriptor, 3u));
  }

  {
    ...
    EXPECT_STREQ(get_member_name(member_descriptor), "int64_values_defaults");
    EXPECT_EQ(get_member_base_type(member_descriptor), ROS_TYPE_INT64);
    EXPECT_TRUE(has_array_structure(int64_values_member_descriptor, 3u));
  }

  {
    ...
    EXPECT_STREQ(get_member_name(member_descriptor), "uint64_values_defaults");
    EXPECT_EQ(get_member_base_type(member_descriptor), ROS_TYPE_UINT64);
    EXPECT_TRUE(has_array_structure(member_descriptor, 3u));
  }

  {
    ...
    EXPECT_STREQ(get_member_name(member_descriptor), "string_values_defaults");
    EXPECT_EQ(get_member_base_type(member_descriptor), ROS_TYPE_STRING);
    EXPECT_TRUE(has_array_structure(member_descriptor, 3u));
  }
...
TYPED_TEST(ArraysMessageIntrospectionTest, CanReadTypeErasedMessage)
{
  ...
  const auto message = make_fixture_instance<ArrayMessageT>();
  const void * type_erased_message = &message;
  ...
  ASSERT_ITERABLE_MEMBER_EQ(
      type_erased_message, message, bool_values_defaults,
      get_member_descriptor(message_descriptor, 17u));

  ASSERT_ITERABLE_MEMBER_EQ(
      type_erased_message, message, byte_values_defaults,
      get_member_descriptor(message_descriptor, 18u));

  ASSERT_ITERABLE_MEMBER_EQ(
      type_erased_message, message, char_values_defaults,
      get_member_descriptor(message_descriptor, 19u));

  ASSERT_ITERABLE_MEMBER_EQ(
      type_erased_message, message, float32_values_defaults,
      get_member_descriptor(message_descriptor, 20u));

  ASSERT_ITERABLE_MEMBER_EQ(
      type_erased_message, message, float64_values_defaults,
      get_member_descriptor(message_descriptor, 21u));

  ASSERT_ITERABLE_MEMBER_EQ(
      type_erased_message, message, int8_values_defaults,
      get_member_descriptor(message_descriptor, 22u));

  ASSERT_ITERABLE_MEMBER_EQ(
      type_erased_message, message, uint8_values_defaults,
      get_member_descriptor(message_descriptor, 23u));

  ASSERT_ITERABLE_MEMBER_EQ(
      type_erased_message, message, int16_values_defaults,
      get_member_descriptor(message_descriptor, 24u));

  ASSERT_ITERABLE_MEMBER_EQ(
      type_erased_message, message, uint16_values_defaults,
      get_member_descriptor(message_descriptor, 25u));

  ASSERT_ITERABLE_MEMBER_EQ(
      type_erased_message, message, int32_values_defaults,
      get_member_descriptor(message_descriptor, 26u));

  ASSERT_ITERABLE_MEMBER_EQ(
      type_erased_message, message, uint32_values_defaults,
      get_member_descriptor(message_descriptor, 27u));

  ASSERT_ITERABLE_MEMBER_EQ(
      type_erased_message, message, int64_values_defaults,
      get_member_descriptor(message_descriptor, 28u));

  ASSERT_ITERABLE_MEMBER_EQ(
      type_erased_message, message, uint64_values_defaults,
      get_member_descriptor(message_descriptor, 29u));

  ASSERT_ITERABLE_MEMBER_EQ(
      type_erased_message, message, string_values_defaults,
...
TYPED_TEST(ArraysMessageIntrospectionTest, CanWriteTypeErasedMessage)
{
  ...
  const ArrayMessageT message = MakeExampleMessage<ArrayMessageT>();
  auto type_erased_message_copy = MakeTypeErasedMessage();
  ...
  ASSERT_ARRAY_MEMBER_ASSIGNMENT(
      type_erased_message_copy.get(), message, bool_values_defaults,
      get_member_descriptor(message_descriptor, 17u));

  ASSERT_ARRAY_MEMBER_ASSIGNMENT(
      type_erased_message_copy.get(), message, byte_values_defaults,
      get_member_descriptor(message_descriptor, 18u));

  ASSERT_ARRAY_MEMBER_ASSIGNMENT(
      type_erased_message_copy.get(), message, char_values_defaults,
      get_member_descriptor(message_descriptor, 19u));

  ASSERT_ARRAY_MEMBER_ASSIGNMENT(
      type_erased_message_copy.get(), message, float32_values_defaults,
      get_member_descriptor(message_descriptor, 20u));

  ASSERT_ARRAY_MEMBER_ASSIGNMENT(
      type_erased_message_copy.get(), message, float64_values_defaults,
      get_member_descriptor(message_descriptor, 21u));

  ASSERT_ARRAY_MEMBER_ASSIGNMENT(
      type_erased_message_copy.get(), message, int8_values_defaults,
      get_member_descriptor(message_descriptor, 22u));

  ASSERT_ARRAY_MEMBER_ASSIGNMENT(
      type_erased_message_copy.get(), message, uint8_values_defaults,
      get_member_descriptor(message_descriptor, 23u));

  ASSERT_ARRAY_MEMBER_ASSIGNMENT(
      type_erased_message_copy.get(), message, int16_values_defaults,
      get_member_descriptor(message_descriptor, 24u));

  ASSERT_ARRAY_MEMBER_ASSIGNMENT(
      type_erased_message_copy.get(), message, uint16_values_defaults,
      get_member_descriptor(message_descriptor, 25u));

  ASSERT_ARRAY_MEMBER_ASSIGNMENT(
      type_erased_message_copy.get(), message, int32_values_defaults,
      get_member_descriptor(message_descriptor, 26u));

  ASSERT_ARRAY_MEMBER_ASSIGNMENT(
      type_erased_message_copy.get(), message, uint32_values_defaults,
      get_member_descriptor(message_descriptor, 27u));

  ASSERT_ARRAY_MEMBER_ASSIGNMENT(
      type_erased_message_copy.get(), message, int64_values_defaults,
      get_member_descriptor(message_descriptor, 28u));

  ASSERT_ARRAY_MEMBER_ASSIGNMENT(
      type_erased_message_copy.get(), message, uint64_values_defaults,
      get_member_descriptor(message_descriptor, 29u));

  ASSERT_ARRAY_MEMBER_ASSIGNMENT(
      type_erased_message_copy.get(), message, string_values_defaults,
      get_member_descriptor(message_descriptor, 30u));
